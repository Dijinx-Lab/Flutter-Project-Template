  ...
  static List<BoxShadow> _getXSmallShadow() {
    return [
      BoxShadow(
        ...
        spreadRadius: 0,
        color: EssentialColors.slate900.withOpacity(0.05),
      )
    ];
  }
  ...
  static List<BoxShadow> _getSmallShadow() {
    return [
      BoxShadow(
        ...
        offset: const Offset(0, 1),
        spreadRadius: 0,
        color: EssentialColors.slate900.withOpacity(0.10),
      ),
      BoxShadow(
        blurRadius: 2,
        offset: const Offset(0, 1),
  ...
  static List<BoxShadow> _getMediumShadow() {
    return [
      ...
      BoxShadow(
        ...
        spreadRadius: -2,
        color: EssentialColors.slate900.withOpacity(0.06),
      )
    ];
  }
  ...
  static List<BoxShadow> _getXLargeShadow() {
    return [
      ...
      BoxShadow(
        ...
        spreadRadius: -4,
        color: EssentialColors.slate900.withOpacity(0.04),
      )
    ];
  }
  ...
  static List<BoxShadow> _getXXLargeShadow() {
    return [
      BoxShadow(
        ...
        spreadRadius: -12,
        color: EssentialColors.slate900.withOpacity(0.25),
      ),
    ];
  }
}
